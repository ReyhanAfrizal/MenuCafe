    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        temanAdapter.setOnItemClickListener(new TemanAdapter.OnItemClickListener() {
            ...
            public void onItemClick(long id) {
                Intent detailData = new Intent(HomeActivity.this, DetailData.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent showCreateForm = new Intent(HomeActivity.this, CreateData.class);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(result > 0){
                            Toast.makeText(HomeActivity.this, "Data Berhasil Dihapus", Toast.LENGTH_LONG).show();
                        }else{
                            Toast.makeText(HomeActivity.this, "Data Gagal Dihapus", Toast.LENGTH_LONG).show();
                        }
